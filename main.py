...
class AppToDo:
    ...
    def pedir_nome_usuario(self):
        ...
        def salvar_usuario(e):
            ...
            self.main()
            self.page.update()  # Adicionado para garantir a atualização da UI
        ...
        campo_usuario = ft.TextField(
            ...
            border_radius=8,
            on_submit=salvar_usuario # Permite confirmar com "Enter"
        )
    ...
    def main(self):
        ...
        # Limpa controles antigos antes de adicionar novos
        self.page.controls.clear()
    ...
    def criar_secao_entrada(self):
        ...
        self.entrada_tarefa = ft.TextField(
            ...
            bgcolor=self.cor['item_fundo'],
            border_radius=8,
            on_submit=self.adicionar_tarefa # Permite adicionar com "Enter"
        )
    ...
    def criar_lista_tarefas(self):
        ...
        return ft.Container(
            ...
            expand=True,  # Usar expand para ocupar o espaço restante
            padding=10,
            bgcolor=self.cor['fundo']
        )
    ...
    def atualizar_lista_tarefas(self, e=None):
        ...
        if not hasattr(self, 'lista_tarefas'):
            return
            ...
            content=ft.Row(
                [
                    ft.Checkbox(
                        ...
                        # A função lambda precisa receber o evento 'e'
                    ...
                    ft.IconButton(
                        ...
                        on_click=lambda e, t=tarefa[0]: self.excluir_tarefa(t)
                    )
                ],
